...
export function kypeToTypeExpression(type: kype.TypeExpression, location = SourceLocation.empty): TypeExpression {
    return toExpression(type, location) as TypeExpression;
}
