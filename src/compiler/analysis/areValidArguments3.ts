...
import { replace, skip, traverse } from "../common/traverse";
 ...
 */
export function areValidArguments3(c: EvaluationContext, args: Expression[], parameters: ParameterDeclaration[], caller: CallExpression, DEBUG = false): Maybe {
